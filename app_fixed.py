...
if st.button("Predict"):
    ...
    st.markdown(f"""
**Input Draw ID:** {draw_id}  
**Sum:** {draw_sum}
""")

    table_md = "| Draw Ahead | Predicted Color | Confidence (%) | Raw Color Counts |
"
    table_md += "|------------|------------------|----------------|-------------------|
"
    ...
    for i in range(1, 6):
        ...
        table_md += f"| t+{i} | {emoji} {top_color} | {confidence:.2f}% | Red: {counts['Red']}, Blue: {counts['Blue']}, Green: {counts['Green']} |
"
